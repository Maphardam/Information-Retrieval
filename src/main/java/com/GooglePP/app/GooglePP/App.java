					...
					if (params[0].equals("create")) {
						...
						if (params.length == 1) {
							...
							if (params[1].equals("create")) {
								...
								System.out.println("create INDEXPATH URL DEPTH");
								System.out.println("       INDEXPATH  The path where the index should be saved");
								System.out.println("       URL        The URL where the crawling should start");
								System.out.println("       DEPTH      The recursion depth of the crawling process");
